...
<a class="v-padding v-font-size" href="{{ asset('vendor/mail-templates/stay-tuned/assets/asset_9fc44c42.bin') }}" style="padding:5px 21px;display:inline-block;color:#000000;font-size:14px;text-decoration:none" target="_self">
      Home
    </a>
<!--[if (mso)|(IE)]></td><![endif]-->
<!--[if (mso)|(IE)]><td style="padding:5px 21px"><![endif]-->
...
<img align="center" alt="image" border="0" src="{{ asset('vendor/mail-templates/stay-tuned/assets/1698215331967-Stay-Tuned2.gif') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" title="image" width="600"/>
</td>
</tr>
</table>
</td>
...
<p style="line-height: 160%;">Prepare for our groundbreaking technology announcement, coming soon!</p>
</div>
</td>
</tr>
</tbody>
...
<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ asset('vendor/mail-templates/stay-tuned/assets/asset_2f8c5a96.bin') }}" style="height:37px; v-text-anchor:middle; width:184px;" arcsize="11%"  strokecolor="#916baf" strokeweight="1px" fillcolor="#ffffff"><w:anchorlock/><center style="color:#000000;"><![endif]-->
<a class="v-button v-size-width v-font-size" href="{{ asset('vendor/mail-templates/stay-tuned/assets/asset_2f8c5a96.bin') }}" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #000000; background-color: #ffffff; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:32%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #916baf; border-top-style: solid; border-top-width: 1px; border-left-color: #916baf; border-left-style: solid; border-left-width: 1px; border-right-color: #916baf; border-right-style: solid; border-right-width: 1px; border-bottom-color: #916baf; border-bottom-style: solid; border-bottom-width: 1px;font-size: 14px;" target="_blank">
...
<a href="{{ asset('vendor/mail-templates/stay-tuned/assets/asset_0c984410.bin') }}" target="_blank" title="Facebook">
<img alt="Facebook" src="{{ asset('vendor/mail-templates/stay-tuned/assets/facebook.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="Facebook" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<table border="0" cellpadding="0" cellspacing="0" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px" width="32">
<tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top" valign="middle">
<a href="{{ asset('vendor/mail-templates/stay-tuned/assets/asset_de62a5c7.bin') }}" target="_blank" title="Twitter">
<img alt="Twitter" src="{{ asset('vendor/mail-templates/stay-tuned/assets/twitter.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="Twitter" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<img alt="LinkedIn" src="{{ asset('vendor/mail-templates/stay-tuned/assets/linkedin.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="LinkedIn" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top" valign="middle">
<a href="{{ asset('vendor/mail-templates/stay-tuned/assets/asset_9fd8adc6.bin') }}" target="_blank" title="Instagram">
<img alt="Instagram" src="{{ asset('vendor/mail-templates/stay-tuned/assets/instagram.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="Instagram" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<p style="font-size: 14px; line-height: 170%;">Join our newsletter to stay updated on groundbreaking tech developments!</p>
</div>
</td>
</tr>
</tbody>
